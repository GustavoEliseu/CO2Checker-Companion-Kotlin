...
const val LOCATION_PERMISSION_REQUEST = 112
const val CAMERA_PERMISSION_REQUEST = 113
const val INTERNET_PERMISSION_REQUEST = 114
...
const val LOCATION_URI = "LOCATION_URI"